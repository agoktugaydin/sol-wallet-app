...
function newWallet() {
    return __awaiter(this, void 0, void 0, function () {
        var keypair, publicKey, balance;
        return __generator(this, function (_a) {
            keypair = web3_js_1.Keypair.generate();
            publicKey = keypair.publicKey.toString();
            balance = 0;
            currentWallet = { keypair: keypair.secretKey.toString(), publicKey: publicKey, balance: balance };
            try {
...
// Test
newWallet()["catch"](function (err) { return console.error(err); });
